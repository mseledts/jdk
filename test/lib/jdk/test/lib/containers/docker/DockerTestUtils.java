...
public class DockerTestUtils {
    ...
    /**
     * Build a container image based on given Dockerfile and container build directory.
     *
     * @param imageName  name of the image to be created, including version tag
    ...
    public static void buildImage(String imageName, Path buildDir) throws Exception {
        try {
            ...
            // If image build fails there is a good chance it happens due to environment and/or
